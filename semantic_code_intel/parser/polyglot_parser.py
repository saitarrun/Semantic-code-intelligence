...
LANGUAGE_PATTERNS: Dict[str, List[Tuple[Pattern[str], SymbolType]]] = {
    ...
    "csharp": [
        (re.compile(r"^(?:public|protected|private|internal|static|abstract|sealed|\s)*(?:class|record)\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^(?:public|protected|private|internal|\s)*interface\s+([A-Za-z0-9_]+)"), SymbolType.INTERFACE),
        (re.compile(r"^(?:public|protected|private|internal|\s)*struct\s+([A-Za-z0-9_]+)"), SymbolType.STRUCT),
        (re.compile(r"^(?:public|protected|private|internal|\s)*enum\s+([A-Za-z0-9_]+)"), SymbolType.ENUM),
        (re.compile(r"^(?:public|protected|private|internal|static|async|override|virtual|\s)+[\w<>\[\],\s]+\s+([A-Za-z0-9_]+)\s*\([^)]*\)\s*\{?"), SymbolType.METHOD),
    ],
    "swift": [
        (re.compile(r"^(?:public|private|internal|open|fileprivate|final|\s)*class\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^(?:public|private|internal|open|fileprivate|\s)*struct\s+([A-Za-z0-9_]+)"), SymbolType.STRUCT),
        (re.compile(r"^(?:public|private|internal|open|fileprivate|\s)*protocol\s+([A-Za-z0-9_]+)"), SymbolType.INTERFACE),
        (re.compile(r"^(?:public|private|internal|open|fileprivate|\s)*enum\s+([A-Za-z0-9_]+)"), SymbolType.ENUM),
        (re.compile(r"^(?:public|private|internal|open|fileprivate|static|mutating|override|\s)*func\s+([A-Za-z0-9_]+)"), SymbolType.FUNCTION),
    ],
    "kotlin": [
        (re.compile(r"^(?:public|private|protected|internal|open|abstract|data|sealed|\s)*class\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^(?:public|private|protected|internal|\s)*object\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^(?:public|private|protected|internal|\s)*interface\s+([A-Za-z0-9_]+)"), SymbolType.INTERFACE),
        (re.compile(r"^(?:public|private|protected|internal|\s)*enum\s+class\s+([A-Za-z0-9_]+)"), SymbolType.ENUM),
        (re.compile(r"^(?:public|private|protected|internal|override|suspend|inline|\s)*fun\s+([A-Za-z0-9_]+)"), SymbolType.FUNCTION),
    ],
    "scala": [
        (re.compile(r"^(?:case\s+)?class\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^object\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^trait\s+([A-Za-z0-9_]+)"), SymbolType.INTERFACE),
        (re.compile(r"^def\s+([A-Za-z0-9_]+)"), SymbolType.FUNCTION),
    ],
    "ruby": [
        (re.compile(r"^class\s+([A-Za-z0-9_:]+)"), SymbolType.CLASS),
        (re.compile(r"^module\s+([A-Za-z0-9_:]+)"), SymbolType.CLASS),
        (re.compile(r"^def\s+(?:self\.)?([A-Za-z0-9_?!]+)"), SymbolType.FUNCTION),
    ],
    "php": [
        (re.compile(r"^(?:abstract|final|\s)*class\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^interface\s+([A-Za-z0-9_]+)"), SymbolType.INTERFACE),
        (re.compile(r"^trait\s+([A-Za-z0-9_]+)"), SymbolType.CLASS),
        (re.compile(r"^(?:public|protected|private|static|\s)*function\s+([A-Za-z0-9_]+)"), SymbolType.FUNCTION),
    ],
    "sql": [
